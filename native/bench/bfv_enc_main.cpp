// BFV encode/encrypt/decrypt runner
#include "bench.h"
#include <iostream>
...
int main(int argc, char **argv)
{
    ...
    cout << "BFV enc/dec bench runner" << endl;
    ...
    // Only keep parameter set with poly_modulus_degree == 32768
    ...
    for (auto &i : bm_parms_vec) register_bm_family_bfv_enc(i, bm_env_map);
